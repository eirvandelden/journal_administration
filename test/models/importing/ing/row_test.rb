...
class Importing::ING::RowTest < ActiveSupport::TestCase
  ...
  test "parse reads who was paid and from which account" do
    row = Importing::ING::Row.parse(valid_csv_row)
  ...
  test "parse reads the amount and how it was paid" do
    row = Importing::ING::Row.parse(valid_csv_row)
